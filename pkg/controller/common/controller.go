	...
	return &namespaceAwareController{
		...
		namespacePredicate: predicate.Funcs{
			CreateFunc: func(e event.CreateEvent) bool {
				return reconciler.IsNamespaceManaged(e.Object.GetNamespace(), managedNamespaces)
			},
			UpdateFunc: func(e event.UpdateEvent) bool {
				return reconciler.IsNamespaceManaged(e.ObjectNew.GetNamespace(), managedNamespaces)
			},
