...
func TestReconcile(t *testing.T) {
	...
	instance := &elasticsearchv1alpha1.Link{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the Link object and expect the Reconcile and Deployment to be created
