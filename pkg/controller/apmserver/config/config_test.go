...
func mkAPMServer(
	...
	esAssociation := apmv1.ApmEsAssociation{ApmServer: apmServer}
	esAssociation.SetAssociationConf(esAssocConf)
	kibanaAssociation := apmv1.ApmKibanaAssociation{ApmServer: apmServer}
	kibanaAssociation.SetAssociationConf(kibanaAssocConf)
	return apmServer
}
