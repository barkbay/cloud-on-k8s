...
// Merge replaces the values for Memory and CPU in a ResourceRequirements with the values from the NodeResources.
...
func (nr *NodeResources) Merge(sourceRequirements corev1.ResourceRequirements) corev1.ResourceRequirements {
