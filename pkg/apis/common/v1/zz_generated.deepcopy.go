...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LocalElasticsearchRef) DeepCopyInto(out *LocalElasticsearchRef) {
	*out = *in
	out.LocalObjectSelector = in.LocalObjectSelector
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LocalElasticsearchRef.
func (in *LocalElasticsearchRef) DeepCopy() *LocalElasticsearchRef {
	if in == nil {
		return nil
	}
	out := new(LocalElasticsearchRef)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LogsMonitoring) DeepCopyInto(out *LogsMonitoring) {
	*out = *in
	if in.ElasticsearchRefs != nil {
		...
		*out = make([]ElasticsearchRef, len(*in))
		copy(*out, *in)
	}
}
