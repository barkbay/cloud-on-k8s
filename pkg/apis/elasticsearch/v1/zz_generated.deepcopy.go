...
func (in *DownscaleOperation) DeepCopyInto(out *DownscaleOperation) {
	*out = *in
	...
	if in.ShardMigrationStatuses != nil {
		in, out := &in.ShardMigrationStatuses, &out.ShardMigrationStatuses
		*out = make(ShardMigrationStatuses, len(*in))
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RollingUpgradeOperation) DeepCopyInto(out *RollingUpgradeOperation) {
	*out = *in
	in.LastUpdatedTime.DeepCopyInto(&out.LastUpdatedTime)
	if in.Nodes != nil {
		in, out := &in.Nodes, &out.Nodes
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RollingUpgradeOperation.
func (in *RollingUpgradeOperation) DeepCopy() *RollingUpgradeOperation {
	if in == nil {
		return nil
	}
	out := new(RollingUpgradeOperation)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ShardMigrationStatus) DeepCopyInto(out *ShardMigrationStatus) {
	*out = *in
	if in.ShardsRemaining != nil {
		in, out := &in.ShardsRemaining, &out.ShardsRemaining
		*out = new(int)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ShardMigrationStatuses) DeepCopyInto(out *ShardMigrationStatuses) {
	{
		in := &in
		*out = make(ShardMigrationStatuses, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ShardMigrationStatuses.
func (in ShardMigrationStatuses) DeepCopy() ShardMigrationStatuses {
	if in == nil {
		return nil
	}
	out := new(ShardMigrationStatuses)
	in.DeepCopyInto(out)
	return *out
}
