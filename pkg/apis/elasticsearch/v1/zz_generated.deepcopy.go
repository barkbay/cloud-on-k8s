...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in NamedTiers) DeepCopyInto(out *NamedTiers) {
	{
		in := &in
		*out = make(NamedTiers, len(*in))
		for key, val := range *in {
			var outVal []NodeSet
			if val == nil {
				(*out)[key] = nil
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NamedTiers.
func (in NamedTiers) DeepCopy() NamedTiers {
	if in == nil {
		return nil
	}
	out := new(NamedTiers)
