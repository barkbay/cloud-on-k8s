...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutoscalingSpecsBuilder) DeepCopyInto(out *AutoscalingSpecsBuilder) {
	*out = *in
	if in.cpu != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutoscalingSpecsBuilder.
func (in *AutoscalingSpecsBuilder) DeepCopy() *AutoscalingSpecsBuilder {
	if in == nil {
		return nil
	}
	out := new(AutoscalingSpecsBuilder)
	in.DeepCopyInto(out)
	return out
}
