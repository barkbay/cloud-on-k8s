...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KibanaEsAssociationResolver) DeepCopyInto(out *KibanaEsAssociationResolver) {
	*out = *in
	if in.Kibana != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KibanaEsAssociationResolver.
func (in *KibanaEsAssociationResolver) DeepCopy() *KibanaEsAssociationResolver {
	if in == nil {
		return nil
	}
	out := new(KibanaEsAssociationResolver)
	in.DeepCopyInto(out)
	return out
}
