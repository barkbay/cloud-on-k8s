...
func (in *ApmEsAssociationResolver) DeepCopyInto(out *ApmEsAssociationResolver) {
	*out = *in
	if in.ApmServer != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApmEsAssociationResolver.
func (in *ApmEsAssociationResolver) DeepCopy() *ApmEsAssociationResolver {
	if in == nil {
		return nil
	}
	out := new(ApmEsAssociationResolver)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ApmKibanaAssociationResolver) DeepCopyInto(out *ApmKibanaAssociationResolver) {
	*out = *in
	if in.ApmServer != nil {
		in, out := &in.ApmServer, &out.ApmServer
		*out = new(ApmServer)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApmKibanaAssociationResolver.
func (in *ApmKibanaAssociationResolver) DeepCopy() *ApmKibanaAssociationResolver {
	if in == nil {
		return nil
	}
	out := new(ApmKibanaAssociationResolver)
	in.DeepCopyInto(out)
	return out
}
